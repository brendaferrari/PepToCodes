    ...
    def dict_json(self, one_code=True):
        ...
        if one_code is True:
            with open("../resources/norineDB.json", "r") as r:
                ...
                smilesCanonical = dict(zip(codeCan, canonicalSmiles))
        ...
        return smilesCanonical, smilesIsomeric

dictio = Dictionary()

smilesCanonical, smilesIsomeric = dictio.dict_json(True, False)
